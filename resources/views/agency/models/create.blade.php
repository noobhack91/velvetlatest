  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
            <form name="add_user" method="POST" enctype="multipart/form-data" action="{{url('agency/createmodel')}}">
            {{csrf_field()}}
            <div class="card card-primary">
                ...
                <div class="card-body my-card-tt">
                    ...
                    <!--<div class="form-group">-->
                    <!--  <label>Hips:</label>-->
                    <!--  <input type="number" id="hips" name="hips" value="{{old('hips')}}">-->
                    <!--</div>-->
                    
                    <!--<div class="form-group">-->
                    <!--  <label>Shoe:</label>-->
                    <!--  <input type="number" id="shoe" name="shoe" value="{{old('shoe')}}">-->
                    <!--</div>-->
                    
                    <div class="form-group">
                      <label>Eyes:</label>
                      <input maxlength="10" type="text" id="eyes" name="eyes" value="{{old('eyes')}}">
                    </div>
