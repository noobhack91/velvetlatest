...
<section class="profile-sec">
        <div class="container">
            <div class="profile-form">
                <!-- multistep form -->
                <form id="regForm" class="my-multistep-form" method="POST" action="{{url('save')}}">
				{{ csrf_field()}}
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="editing-form-value-cell">
                                            <select name="country" id="select_country" class="form-control" required>
									...
									<div id="signupForm">
										...
										<div class="form-group">
											<div class="editing-form-label-cell">
												<label for="Mobile"
													class="control-label editing-form-label">I am 18+ of age. <br> I accept terms and condition.</label>
											</div>
											<div class="editing-form-value-cell">
            ...
            <div style="overflow:auto;margin-top: 10px;" class="my-mt-buttons">
