                ...
                <div style="width:80%" >
                    ...
                    <div>
                        ...
                        <div style="display: grid; grid-template-columns: 33% 33% 33% ; " > 
                            ...
                            <ul>
                                <h2 style="text-decoration: underline;" ><b>Top Level pages</b></h2>

                                <li><a href="{{ url('/') }}">Home</a></li>
                                <li><a href="{{ url('popular-locations') }}">Search for Local </a></li>
                                <li><a href="{{ url('/login') }}">Login</a></li>
                                <li><a href="{{ url('/about-us') }}">Documentation</a></li>
                            ...
                            <ul>
                                <h2 style="text-decoration: underline;" ><b>Documentation</b></h2>

                                <li><a href="{{ url('/about-us') }}">About </a></li>
                                <li><a href="{{ url('/about-us') }}">Site User FAQs</a></li>
                                <li><a href="{{ url('/about-us') }}">Advertiser FAQs</a></li>
                                <li><a href="{{ url('/about-us') }}"> Advertiser Account Type   </a></li>
                                <li><a href="{{ url('/about-us') }}">Advertiser Packages</a></li>
                                <li><a href="{{ url('/about-us') }}">Terms and Definitions</a></li>
                            ...
                            <ul>
                                <h2 style="text-decoration: underline;" ><b>Legal Pages</b></h2>

                                <li><a href="{{ url('/term-and-conditions') }}">Terms and Condations</a></li>
                                <li><a href="{{ url('/privacy-and-policy') }}">Privacy Policy</a></li>
                                <li><a href="{{ url('/replacement') }}">Delivery/refund Policy</a></li>
                    ...
                    <h2>Browse Escorts by Location</h2> 
