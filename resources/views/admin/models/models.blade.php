                        ...
                        @foreach($users as $k=>$user)
                            <tr>
                                ...
                                <td class="project-actions my-project-tt">
                                    ...
                                    <form action="{{url('admin/model/delete/'.encrypt($user->id))}}" method="post" class="delete_user_form">
                                    @csrf  
                                    @method('DELETE')    
                                  ...
                                  <form action="{{url('admin/model/edit/'.encrypt($user->id))}}" method="get" class="edit_user_form">
                                    @csrf  
