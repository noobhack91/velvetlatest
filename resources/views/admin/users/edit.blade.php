  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
            <form name="update_user" method="POST" enctype="multipart/form-data" action="{{url('admin/user/update/'.encrypt($user->id))}}">
            @csrf
            @method('PUT')
            <div class="card card-primary">
                ...
                <div class="card-body my-card-tt">
                    ...
                    <!--    <input type="text" id="preferences" name="preferences" value="{{ isset($user->usermeta) && !empty($user->usermeta->preferences) ? $user->usermeta->preferences : '' }}" required>-->
                    <!--</div>-->
